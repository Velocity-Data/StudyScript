...
if __name__ == '__main__':
    ...
    print(' ')
    print('''Welcome to the CompTIA A+ Study Script.! This is an easy to use digital flash-card 
        ...
        it will give you you're score as a percentage so you know if you did well or not.''')
    print(' ')
